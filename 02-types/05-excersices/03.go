...
1. En scope a nivel de paquete, asigna los siguientes valores a las tres variables
	...
	c. a z asignale true
2. en main
	a. Usa fmt.Sprintf para imprimir todos los VALORES en un solo string. ASIGNA el
	valor retornado de TIPO string usando el operador de declaración corta a la
